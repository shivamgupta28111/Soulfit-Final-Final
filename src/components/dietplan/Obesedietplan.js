...
class Obesedietplan extends Component{
  ...
  componentDidMount(meal_types) {
    ...
    const vname2Ref = rootRef.child('Veg/Dinner/Recipe1/name');
    const vnutrients2Ref = rootRef.child('Veg/Dinner/Recipe1/nutrients');
    const vingr2Ref = rootRef.child('Veg/Dinner/Recipe1/ingr');
    const vprep2Ref = rootRef.child('Veg/Dinner/Recipe1/prep');
    ...
    const vname4Ref = rootRef.child('Veg/Breakfast/Recipe2/name');
    const vnutrients4Ref = rootRef.child('Veg/Breakfast/Recipe2/nutrients');
    const vingr4Ref = rootRef.child('Veg/Breakfast/Recipe2/ingr');
    const vprep4Ref = rootRef.child('Veg/Breakfast/Recipe2/prep');
    ...
    const nvname1Ref = rootRef.child('NVeg/Lunch/Recipe2/name');
    const nvnutrients1Ref = rootRef.child('NVeg/Lunch/Recipe2/nutrients');
    const nvingr1Ref = rootRef.child('NVeg/Lunch/Recipe2/ingr');
    const nvprep1Ref = rootRef.child('NVeg/Lunch/Recipe2/prep');
    ...
    const nvname2Ref = rootRef.child('NVeg/Dinner/Recipe1/name');
    const nvnutrients2Ref = rootRef.child('NVeg/Dinner/Recipe1/nutrients');
    const nvingr2Ref = rootRef.child('NVeg/Dinner/Recipe1/ingr');
    const nvprep2Ref = rootRef.child('NVeg/Dinner/Recipe1/prep');
    ...
    const nvname4Ref = rootRef.child('NVeg/Breakfast/Recipe2/name');
    const nvnutrients4Ref = rootRef.child('NVeg/Breakfast/Recipe2/nutrients');
    const nvingr4Ref = rootRef.child('NVeg/Breakfast/Recipe2/ingr');
    const nvprep4Ref = rootRef.child('NVeg/Breakfast/Recipe2/prep');
    ...
    const kname1Ref = rootRef.child('Keto/Lunch/Recipe2/name');
    const knutrients1Ref = rootRef.child('Keto/Lunch/Recipe2/nutrients');
    const kingr1Ref = rootRef.child('Keto/Lunch/Recipe2/ingr');
    const kprep1Ref = rootRef.child('Keto/Lunch/Recipe2/prep');
    ...
    const kname2Ref = rootRef.child('Keto/Dinner/Recipe1/name');
    const knutrients2Ref = rootRef.child('Keto/Dinner/Recipe1/nutrients');
    const kingr2Ref = rootRef.child('Keto/Dinner/Recipe1/ingr');
    const kprep2Ref = rootRef.child('Keto/Dinner/Recipe1/prep');
    ...
    const kname4Ref = rootRef.child('Keto/Breakfast/Recipe2/name');
    const knutrients4Ref = rootRef.child('Keto/Breakfast/Recipe2/nutrients');
    const kingr4Ref = rootRef.child('Keto/Breakfast/Recipe2/ingr');
    const kprep4Ref = rootRef.child('Keto/Breakfast/Recipe2/prep');
...
Obesedietplan.propTypes = {
  classes: PropTypes.object.isRequired,
  theme: PropTypes.object.isRequired,
};

export default withStyles(styles, { withTheme: true })(Obesedietplan);