...
class Overweightdietplan extends Component{
  ...
  componentDidMount(meal_types) {
    ...
    const vname1Ref = rootRef.child('Veg/Lunch/Recipe2/name');
    const vnutrients1Ref = rootRef.child('Veg/Lunch/Recipe2/nutrients');
    const vingr1Ref = rootRef.child('Veg/Lunch/Recipe2/ingr');
    const vprep1Ref = rootRef.child('Veg/Lunch/Recipe2/prep');
    ...
    const vname2Ref = rootRef.child('Veg/Dinner/Recipe3/name');
    const vnutrients2Ref = rootRef.child('Veg/Dinner/Recipe3/nutrients');
    const vingr2Ref = rootRef.child('Veg/Dinner/Recipe3/ingr');
    const vprep2Ref = rootRef.child('Veg/Dinner/Recipe3/prep');
    ...
    const vname3Ref = rootRef.child('Veg/Dinner/Recipe1/name');
    const vnutrients3Ref = rootRef.child('Veg/Dinner/Recipe1/nutrients');
    const vingr3Ref = rootRef.child('Veg/Dinner/Recipe1/ingr');
    const vprep3Ref = rootRef.child('Veg/Dinner/Recipe1/prep');
    ...
    const vname4Ref = rootRef.child('Veg/Breakfast/Recipe3/name');
    const vnutrients4Ref = rootRef.child('Veg/Breakfast/Recipe3/nutrients');
    const vingr4Ref = rootRef.child('Veg/Breakfast/Recipe3/ingr');
    const vprep4Ref = rootRef.child('Veg/Breakfast/Recipe3/prep');
    ...
    const nvname1Ref = rootRef.child('NVeg/Lunch/Recipe3/name');
    const nvnutrients1Ref = rootRef.child('NVeg/Lunch/Recipe3/nutrients');
    const nvingr1Ref = rootRef.child('NVeg/Lunch/Recipe3/ingr');
    const nvprep1Ref = rootRef.child('NVeg/Lunch/Recipe3/prep');
    ...
    const nvname2Ref = rootRef.child('NVeg/Dinner/Recipe3/name');
    const nvnutrients2Ref = rootRef.child('NVeg/Dinner/Recipe3/nutrients');
    const nvingr2Ref = rootRef.child('NVeg/Dinner/Recipe3/ingr');
    const nvprep2Ref = rootRef.child('NVeg/Dinner/Recipe3/prep');
    ...
    const nvname3Ref = rootRef.child('NVeg/Dinner/Recipe1/name');
    const nvnutrients3Ref = rootRef.child('NVeg/Dinner/Recipe1/nutrients');
    const nvingr3Ref = rootRef.child('NVeg/Dinner/Recipe1/ingr');
    const nvprep3Ref = rootRef.child('NVeg/Dinner/Recipe1/prep');
    ...
    const nvname4Ref = rootRef.child('NVeg/Breakfast/Recipe3/name');
    const nvnutrients4Ref = rootRef.child('NVeg/Breakfast/Recipe3/nutrients');
    const nvingr4Ref = rootRef.child('NVeg/Breakfast/Recipe3/ingr');
    const nvprep4Ref = rootRef.child('NVeg/Breakfast/Recipe3/prep');
    ...
    const kname1Ref = rootRef.child('Keto/Lunch/Recipe3/name');
    const knutrients1Ref = rootRef.child('Keto/Lunch/Recipe3/nutrients');
    const kingr1Ref = rootRef.child('Keto/Lunch/Recipe3/ingr');
    const kprep1Ref = rootRef.child('Keto/Lunch/Recipe3/prep');
    ...
    const kname2Ref = rootRef.child('Keto/Dinner/Recipe3/name');
    const knutrients2Ref = rootRef.child('Keto/Dinner/Recipe3/nutrients');
    const kingr2Ref = rootRef.child('Keto/Dinner/Recipe3/ingr');
    const kprep2Ref = rootRef.child('Keto/Dinner/Recipe3/prep');
    ...
    const kname3Ref = rootRef.child('Keto/Dinner/Recipe1/name');
    const knutrients3Ref = rootRef.child('Keto/Dinner/Recipe1/nutrients');
    const kingr3Ref = rootRef.child('Keto/Dinner/Recipe1/ingr');
    const kprep3Ref = rootRef.child('Keto/Dinner/Recipe1/prep');
    ...
    const kname4Ref = rootRef.child('Keto/Breakfast/Recipe3/name');
    const knutrients4Ref = rootRef.child('Keto/Breakfast/Recipe3/nutrients');
    const kingr4Ref = rootRef.child('Keto/Breakfast/Recipe3/ingr');
    const kprep4Ref = rootRef.child('Keto/Breakfast/Recipe3/prep');
...
Overweightdietplan.propTypes = {
  classes: PropTypes.object.isRequired,
  theme: PropTypes.object.isRequired,
};

export default withStyles(styles, { withTheme: true })(Overweightdietplan);